            ...
            <div className="container max-w-6xl mx-auto px-4 md:px-6">
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        <h2 className="text-2xl md:text-4xl font-bold font-batman mb-6 text-foreground leading-tight">
                            {title}
                        </h2>
                    ...
                    <motion.div
                        ...
                        className="bg-card border border-border p-8 rounded-3xl backdrop-blur-sm shadow-xl"
                    >
                        <ul className="space-y-6">
                            {reasons.map((reason, index) => (
                                <li key={index} className="flex items-start gap-4">
                                    ...
                                    <span className="text-lg text-foreground/80 font-medium">{reason}</span>
                                </li>
                            ))}
                        </ul>
                    </motion.div>
