            ...
            <div className="w-full flex">
                    ...
                    <div className="flex gap-5 max-md:flex-col relative w-full ">
                        ...
                        <div className="absolute right-0 top-1/2 -translate-y-1/2">
                            <a href="https://wa.me/919211265558"
                                target="_blank" className="bg-primary px-6 py-3 max-md:px-3 max-md:py-2 rounded-l-xl text-foreground font-medium hover:bg-primary/90 transition ease-in-out duration-200">
                                Enquiry now
                            </a>
                        </div>
                    </div>
                ...
                <div className="flex w-[30%] max-md:hidden flex-col justify-center gap-5 border-l border-b border-r">
                    <div className=" w-full rounded-2xl p-6 space-y-4">
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <div className="flex items-center space-x-3">
                                <button
                                    ...
                                    className="px-3 py-1 bg-foreground/5 rounded-full hover:bg-foreground/5"
                                >
                                    -
                                </button>
                        ...
                        {/* Offer */}
                        {/* <p className="text-sm text-rh-gold cursor-pointer">
            ...
            <div className="space-y-6 px-20 max-md:px-5">
                ...
                <div>
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                        ...
                        <br />
                        <span className="text-sm text-muted-foreground">(Source: Industry Research Report and Annual Report)</span>
                    </p>
                </div>
