    ...
    return (
        <motion.div
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-10">
                ...
                <div>
                    <p className="text-muted-foreground text-sm mb-1">ISIN</p>
                    <p className="text-xl max-sm:text-lg ">INE852S01026</p>
                </div>
                <div>
                    <p className="text-muted-foreground text-sm mb-1">Face Value</p>
                ...
                <div>
                    <p className="text-muted-foreground text-sm mb-1">Book Value</p>
                    <p className="text-xl max-sm:text-lg ">13.9</p>
                </div>
                <div>
                    <p className="text-muted-foreground text-sm mb-1">Debt / Equity Ratio</p>
