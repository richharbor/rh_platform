...
const Feature = ({
    ...
    return (
        ...
        >
            ...
            <div className="mb-4 w-fit group-hover/feature:scale-75 ease-in-out transition-all duration-500 h-12 relative z-10 px-10 text-muted-foreground">
                {icon}
            </div>
            <div className="text-lg font-bold mb-2 relative z-10 px-10">
                <div className="absolute  left-0 inset-y-0 h-6 group-hover/feature:h-8 group-hover/feature:-translate-y-1 transform-gpu w-1 rounded-tr-full ease-in-out rounded-br-full bg-card group-hover/feature:bg-rich-violet transition-all duration-300 origin-center" />
...
export default function JoinLeague() {
    return (
        <div className="flex rounded-2xl flex-col gap-10 max-md:gap-2 h-full mx-auto w-full lg:max-w-screen-xl px-2 lg:px-20 py-20 max-md:py-5">
            <h2 className="text-2xl font-batman mx-20 max-sm:mx-5 md:text-4xl text-center lg:text-5xl font-medium !leading-tight text-transparent bg-clip-text bg-gradient-to-b from-foreground to-foreground/70">How Can Rich Harbor Help Your Business?</h2>
