...
export default function SmeIpoHowToApply() {
  return (
    ...
    <section className="w-full max-w-7xl mx-auto text-foreground py-20 px-6 md:px-12 lg:px-20 rounded-2xl">
      ...
      <div className="relative border-l border-border ml-4 space-y-10">
        {steps.map((step, i) => (
          <div key={i} className="ml-8">
            <div className="absolute -left-4 flex items-center justify-center h-10 w-10 rounded-full bg-rich-violet text-foreground">
