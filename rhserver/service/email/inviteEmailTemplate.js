// Ported from tps-next-backend's utils/inviteEmailTemplate.js, stripped of
// TPS branding.
const inviteEmailTemplate = () => `
        ...
        <div style="display: none; max-height: 0; overflow: hidden;">
            You've been invited to join the Rich Harbor admin platform - click to accept your invitation
        </div>
                ...
                <tr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <td style="padding-bottom: 20px; color: #666666;">
                            <p>Hello,</p>
                            <p>You've been invited to join the Rich Harbor admin platform. We're excited to have you on board!</p>
                ...
                <tr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <td style="color: #999999; font-size: 12px; text-align: center;">
                            <p>&copy; ${new Date().getFullYear()} Rich Harbor. All rights reserved.</p>
                            <p>
