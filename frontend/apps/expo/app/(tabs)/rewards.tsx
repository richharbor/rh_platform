...
export default function RewardsScreen() {
  ...
  return (
    <ScrollView contentInsetAdjustmentBehavior="automatic">
      <YStack flex={1} background="$background" padding="$6" gap="$4">
        ...
        <XStack gap="$3" flexWrap="wrap">
          <YStack background="$color1" borderRadius="$8" padding="$4" borderWidth={1} borderColor="$color3" flexGrow={1}>
            <Text fontWeight="700" color="$color12">
              Active contests
            </Text>
        ...
        <YStack background="$color1" borderRadius="$8" padding="$5" borderWidth={1} borderColor="$color3" gap="$3">
          <Text fontWeight="700" color="$color12">
            Incentive mapping
          </Text>
          {[
